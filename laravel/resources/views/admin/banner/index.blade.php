                          ...
                          <div class="row mb-2">
                              ...
                              <div class="col-sm-8">
                                  <div class="text-sm-right">
                                      <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i><a href="{{route('banner.create')}}">Thêm Mới</a></button>
                                  </div>
                              </div><!-- end col-->
                          </div>
                                  ...
                                  <tbody>
                                    @foreach($cate ?? '' as $banner)
                                          <tr>
                                              ...
                                              <td>
                                                <img src="{{asset('images/'. $banner->image)}}" width="70" />
                                              </td>
                                              <td>
                                                {{$banner->desc}}
                                              </td>
                                              ...
                                              <td>
                                                  @if($banner->status == 1)
                                                      <form action="{{ route('completedUpdate', $banner->id) }}" method="POST">
                                                          {{ csrf_field() }}

          ...
          <div class="row">
              <div class="col-12">
                  <div class="page-title-box d-flex align-items-center justify-content-between">
                      <h4 class="mb-0 font-size-18">Loại Sản Phẩm</h4>
                          ...
                          <div class="row mb-2">
                              ...
                              <div class="col-sm-8">
                                  <div class="text-sm-right">
                                      <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i><a href="{{route('category.create')}}">Thêm Mới</a></button>
                                  </div>
                              </div><!-- end col-->
                          </div>
                                  ...
                                  <tbody>
                                    @foreach($cate ?? '' as $category)
                                          <tr>
                                              ...
                                              <td>{{$category->name}}</td>
                                              <td>
                                                <img src="{{asset('images/'. $category->image)}}" width="70" />
                                              </td>
                                              <td>
                                                {{$category->desc}}
                                              </td>
